...
class PequePatitoVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by PequePatitoParser#operador.
    def visitOperador(self, ctx:PequePatitoParser.OperadorContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by PequePatitoParser#operador_factor.
    def visitOperador_factor(self, ctx:PequePatitoParser.Operador_factorContext):
        return self.visitChildren(ctx)
